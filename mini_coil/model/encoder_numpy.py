...
Same as `Encoder`, but instead of being a PyTorch model, it is a pure Numpy.
By doing this, we avoid dependency on PyTorch, and we can use this model in a pure Python environment.
