...
python -m mini_coil.training.distill_train \
  --student-vocab-path data/model_8000_4d.vocab \
  --student-encoder-path data/model_8000_4d.npy \
  --teacher-model-name "mixedbread-ai/mxbai-embed-large-v1" \
  --train-file data/openwebtext-1920-sentences-vector.txt \
  --batch-size 32 \
  --epochs 20
